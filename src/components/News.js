...
export class News extends Component {
    ...
    async upded(){
        this.props.setp(0);
        console.log("render")
        let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=${this.props.api}&page=${this.state.pag}&pageSize=${this.props.page}`;
